...
export const CLIENT_ID: string = String(
...
export function setAccessToken() {
  ...
  const oauthData = _.fromPairs(
    location.hash.split("&").map(pair => pair.split("="))
  );
  ...
  oauthData.expires_at = +new Date() + oauthData.expires_in;
